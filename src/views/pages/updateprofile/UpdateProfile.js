...
const UpdateProfile = () => {
      ...
      .then((res) => {
        ...
        if (dataResponse === "Record Found") {
          ...
          WriteLog(
            "Message",
            "UpdateProfile",
            "useEffect /position/viewallposition",
            dataResponse,
            userID
          );
        }
      ...
      axios
        ...
        .then((res) => {
          ...
          if (dataResponse == "Profile Found") {
            ...
            setValues({
              ...values,
              categoryID: res.data.result[0].groupTypeID,
  ...
  function handleSubmit(event) {
    try {
          ...
          .then((res) => {
            ...
            if (dataResponse == "Upload Success") {
              ...
              WriteLog(
                "Message",
                "UpdateProfile",
                "handleSubmit /auth/updateProfile",
                " Update Profile " +
                  "\n Name: " +
                  lastname +
                  ", " +
      ...
      } else AlertMessages("All fields must not be empty !", "Error");
    } catch (err) {
      AlertMessages("Error in profile", "Error");
                ...
                <CCardBody>
                  ...
                  <CInputGroup size="sm" className="mb-3">
                    ...
                    >
                      {position.map((val, result) => (
                        <option name={val.id} key={val.id} value={val.id}>
                          {" "}
                          {val.positionName}{" "}
                        </option>
                      ))}
                  ...
                  <CInputGroup size="sm" className="mb-3">
                    <TextField
                      ...
                      error={values.firstname ? false : true}
                    />
                  </CInputGroup>
                  <CInputGroup size="sm" className="mb-3">
                    <TextField
                      ...
                      error={values.lastname ? false : true}
                    />
                  </CInputGroup>
                </CCardBody>
              </CCol>
                ...
                <CCardBody>
                  <CInputGroup size="sm" className="mb-3">
                    <TextField
                      ...
                      error={values.displayname ? false : true}
                    />
                  </CInputGroup>
                  <CInputGroup size="sm" className="mb-3">
                    <TextField
