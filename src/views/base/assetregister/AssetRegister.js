        ...
        .then((res) => {
          ...
          if (dataResponse == "Record Found") {
            ...
            WriteLog(
              "Error",
              "AssetEdit",
              "LoadSupplier /supplier/getsupplier",
              res.data.message2,
              userID
            );
          }
                ...
                <CInputGroup size="sm" className="mb-3">
                  <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DatePicker
                      ...
                      error={dateDepreciated ? false : true}
                    />
                  </LocalizationProvider>
                </CInputGroup>
              </CCardBody>
            ...
            <CCol>
              ...
              <CRow>
                <CCardBody xs={6}>
                  <CInputGroup size="sm" className="mb-3">
                    <div
                      className="CCardBody img1"
                      width={"100%"}
                      height={"100%"}
                    >
                      <img
                        src={file ? URL.createObjectURL(file) : myimage}
                        alt=""
                        style={{
                          width: "80%",
                          textAlign: "center",
